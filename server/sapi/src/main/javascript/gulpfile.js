...
gulp.task('scripts:typescript', function() {
    return gulp.src(['app/**/*.ts', './node_modules/com.revolutionlandscaping.businessmanager.api/*.ts', './node_modules/org.roylance.yadel.api/*.ts', './node_modules/org.roylance.yaas.api/*.ts'])
        .pipe(ts())
        .pipe(gulp.dest("dest"));
});
